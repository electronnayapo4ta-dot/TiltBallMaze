package com.yourcompany.tiltballmaze.ui.levels

import android.content.Intent
import android.os.Bundle
import androidx.appcompat.app.AppCompatActivity
import com.yourcompany.tiltballmaze.databinding.ActivityLevelSelectBinding
import com.yourcompany.tiltballmaze.game.data.GamePreferences
import com.yourcompany.tiltballmaze.game.ui.GameActivity
...
class LevelSelectActivity : AppCompatActivity() {
    ...
    private fun updateButtonIcon(button: android.widget.Button, level: Int) {
        ...
        val leftIcon = when {
            !unlocked -> com.yourcompany.tiltballmaze.R.drawable.ic_lock
            completed -> com.yourcompany.tiltballmaze.R.drawable.ic_check
            else -> com.yourcompany.tiltballmaze.R.drawable.ic_unlock
        }
        val rightIcon = if (hasBestTime) com.yourcompany.tiltballmaze.R.drawable.ic_star else 0
